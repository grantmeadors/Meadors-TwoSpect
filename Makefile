...
GIT = /usr/bin/git
GLUE_PREFIX = /home/gmeadors/master/opt/lscsoft/glue
GREP = /bin/grep
GSL_CFLAGS =  
...
LDADD = $(top_builddir)/src/lalapps/liblalapps.la $(top_builddir)/src/lalapps/liblalapps.la
LDFLAGS = 
LIBOBJS = 
...
PSS_CFLAGS = 
PSS_LIBS = 
PYLAL_PREFIX = /home/gmeadors/master/opt/lscsoft/pylal
...
builddir = .
configure_date = 2014-08-06T21:18:13-0700
datadir = ${datarootdir}
