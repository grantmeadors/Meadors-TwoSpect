...
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DISTCHECK_CONFIGURE_FLAGS =  '--disable-lalmetaio' '--disable-lalframe' '--disable-lalxml' '--disable-lalsimulation' '--disable-lalburst' '--disable-lalinspiral' '--disable-lalstochastic' '--disable-lalinference'
DLLTOOL = false
DSYMUTIL = 
DUMPBIN = 
DVIPS = dvips
...
LAL_OCTAVE_PATH = 
LAL_PYTHON_PATH = /home/gmeadors/master/opt/lscsoft/lalpulsar/lib64/python2.6/site-packages:/home/gmeadors/master/opt/lscsoft/lal/lib64/python2.6/site-packages
...
LDFLAGS = 
LIBOBJS = 
LIBS =  -llalpulsar -llal -lgsl -lgslcblas -lfftw3 -lfftw3f -lm  -llalsupport -lz -llal -lgsl -lgslcblas -lfftw3 -lfftw3f -lm  -llal -lgsl -lgslcblas -lfftw3 -lfftw3f -lm  -lmetaio  -lm -lFrame -lfftw3 -lfftw3f  -lfftw3 -lfftw3f -lm -lgsl -lgslcblas  -lgsl -lgslcblas -lm -lz -lm 
...
ac_configure_args =  '--prefix=/home/gmeadors/master/opt/lscsoft/lalapps' '--disable-lalmetaio' '--disable-lalframe' '--disable-lalxml' '--disable-lalsimulation' '--disable-lalburst' '--disable-lalinspiral' '--disable-lalstochastic' '--disable-lalinference'
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = 
ac_ct_DUMPBIN = 
